...
describe("<ProjectCard />", () => {
  ...
  it("renders project properly", () => {
    ...
    screen.getByText(/Testideskriptio\.\.\./i);
  ...
  it("Tarkastetaan, että renderöity projektin nimi sisältää linkin sen sivulle", async () => {
    setup();
    expect(
      screen.getByText(/Testideskriptio\.\.\./i).closest("a")
